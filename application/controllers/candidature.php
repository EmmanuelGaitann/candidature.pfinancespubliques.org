...
//                Creation de l'email a envoyé'
                ...
                $this->email->from('info@pfinancespubliques.org', '[PSSFP] DEPOT de CANDIDATURE 11eme PROMOTION 2023/2024');
                ...
                $this->email->message('<strong>Dossier N°</strong> : '.$id.'<br/>
                                        ...
                                        <strong>'.$this->input->post('civilite').'</strong> : '.$this->input->post('nom'). ' '.$this->input->post('prenom'). '<br/>
