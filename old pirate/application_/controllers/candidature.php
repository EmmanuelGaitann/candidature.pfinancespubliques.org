...
//            $this->form_validation->set_rules('langue', 'langue', 'trim|required');
		...
		$this->form_data->type_etude= $this->input->post('type_etude');
                ...
                $this->form_data->nom_prenom = $this->input->post('nom_prenom');
                ...
                $this->form_data->nombre_enfant = $this->input->post('nombre_enfant');
                $this->form_data->langue = 'Français';
                $this->form_data->paysresidence = $this->input->post('paysresidence');
		    ...
		    'telephone2' => $this->input->post('telephone2'),
                    ...
                    'id_pays' => $this->input->post('paysresidence'),
                    'pays_residence' => $this->model->get_by_id("pays", $this->input->post('paysresidence'), "id")->row()->nom,
...
//                Creation de l'email a envoyé'
		...
		$email_setting['mailtype'] = 'html';
                ...
                $this->email->from('info@pfinancespubliques.org', '[PSSFP] DEPOT de CANDIDATURE 2015');
                ...
                $this->email->message('<strong>Dossier N°</strong> : '.$id.'<br/>
                                        <strong>N° de téléphone</strong> : '.$this->input->post('telephone'). '<br/>
                                        <strong>'.$this->input->post('civilite').'</strong> : '.$this->input->post('nom_prenom'). '<br/>
                    Nous vous informons que votre candidature a bien été enregistrée: <br/>
                      - <strong>Spécialité</strong> : '.$specialite_candidat->nom. '<br/>
                      - <strong>Type de formation</strong> : '.$this->input->post('type_etude'). '<br/>
                      - <strong>Statut</strong> : '.$this->input->post('statut_prof'). '<br/>
                      - <strong>Administration d\'origine</strong> : '.$this->input->post('structure'). '<br/>
                      - <strong>Nationalité</strong> : '.$this->input->post('nationalite'). '<br/>
                         
                    <h3><a href="http://candidature.pfinancespubliques.org/index.php/impression/imprimer_fiche/'.$id.'"> Vous pouvez à tout moment télécharger votre fiche de candidature ici </a> </h3> 
                    
                   <h3>Modifier à tout moment les informations liées à votre candidature <a href="http://candidature.pfinancespubliques.org/index.php/candidature/initupdate">ici</a> en utilisant les coordonnées suivantes:</h3>
                   
                    <strong>Numéro d\'ordre</strong> : ' . $id.'<br/>
                    <strong>N° de téléphone</strong> : '.$this->input->post('telephone').'<br/> <br/>
                        
                    <p style="color: #ddd;">
                    ------------------------------------------------------------<br/>
                           PSSFP: B.P: 16 578 Yaoundé – Cameroun <br/> 
                           Tel.: + (237) 242 22 76 81  <br/>
                                   (237) 242 23 37 06  <br/>
                                   (237) 697 92 13 32</p>
                    ');
	...
	$this->form_data->type_etude= $candidature->type_etude;
        ...
        $this->form_data->nom_prenom = $candidature->nom_prenom;
        ...
        $this->form_data->paysresidence = $candidature->id_pays;
...
//                Creation de l'email a envoyé'
		...
		$email_setting['mailtype'] = 'html';
                ...
                $this->email->message('<strong>Dossier N°</strong> : '.$candidature->id.'<br/>
                                        <strong>N° de téléphone</strong> : '.$this->input->post('telephone'). '<br/>
                                        <strong>'.$this->input->post('civilite').'</strong> : '.$this->input->post('nom_prenom'). '<br/>
                    Nous vous informons que votre candidature a bien été enregistrée: <br/>
                      - <strong>Spécialité</strong> : '.$specialite_candidat->nom. '<br/>
                    ...
                    <h3><a href="http://candidature.pfinancespubliques.org/index.php/impression/imprimer_fiche/'.$candidature->id.'"> Vous pouvez à tout moment télécharger votre fiche de candidature ici </a> </h3> 
                    
                   <h3>Modifier à tout moment les informations liées à votre candidature <a href="http://candidature.pfinancespubliques.org/index.php/candidature/initupdate">ici</a> en utilisant les coordonnées suivantes:</h3>
                   
                    <strong>Numéro d\'ordre</strong> : ' . $candidature->id.'<br/>
                    <strong>N° de téléphone</strong> : '.$candidature->telephone.'<br/> <br/>
        ...
        $this->template->layout('updatecandidat', $data);
    }
