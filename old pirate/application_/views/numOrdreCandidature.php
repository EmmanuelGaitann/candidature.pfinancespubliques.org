...
//                    $succes="message";
                    if (isset($succes) && $succes != '') { ?>
                        ...
                        ?>
                        <div style="text-align: center">Nous vous informons que votre candidature a bien été enregistré. <br/>Bien vouloir noter les informations suivantes. Elles vous serviront à vous connecter et à pouvoir mettre à jour votre candidature. </div><br/>
